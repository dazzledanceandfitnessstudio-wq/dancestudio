...
export default function SinglePostPage() {
  ...
  // 🔥 FIX: Get content from description or content field
  const postContent = post.description || post.content || post.excerpt || "No content available.";
  ...
  return (
    <div className="posts-page">
      ...
      <main style={{ maxWidth: "800px", margin: "0 auto", padding: "2.5rem 1.5rem 5rem" }}>
        ...
        {/* 🔥 FIX: Show description/content properly */}
        {post.description ? (
          <div style={{
            fontSize: "1.0625rem",
            lineHeight: "1.8",
